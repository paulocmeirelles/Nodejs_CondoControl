...
post - /boleto (passando json com o campo nome_sacado, id_lote, valor e linha_digitavel cria um registro - Não precisa conter tudo isso, mas é bom criar o registro completo)
